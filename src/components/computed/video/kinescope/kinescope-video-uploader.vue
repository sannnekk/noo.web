<template>
  <div
    class="kinescope-video-uploader"
    v-auto-animate
  >
    <label
      class="kinescope-video-uploader__drop-region"
      :class="{ 'kinescope-video-uploader__drop-region--drag': isDragActive }"
      v-if="!fileRef"
      :for="componentId"
    ...
    >
      <h3 class="kinescope-video-uploader__drop-region__label">
        Кликните или перетащите файл сюда
      </h3>
      <p class="kinescope-video-uploader__drop-region__hint">
    ...
    <div
      class="kinescope-video-uploader__uploader"
      v-if="uploading || fileRef"
    >
      <div
        class="kinescope-video-uploader__uploader__progress"
        v-if="!error"
      >
        <h1>{{ progress }}%</h1>
      ...
      <div
        class="kinescope-video-uploader__uploader__actions"
        v-if="!error"
      >
        <common-button
          design="inline"
      ...
      <div
        class="kinescope-video-uploader__uploader__error"
        v-if="error"
      >
        <error-block>
...
const componentId = `kinescope-uploader-${uuid()}`
