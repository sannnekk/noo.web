<template>
  <div class="email-remove-view">
    ...
    <text-area
      v-model="emailsRaw"
      label="Список email для удаления с курса (каждый с новой строки, пробелы не учитываются)"
    />
    <div>
      <span>
        Количество email:
...
function removeEmails() {
  courseStudentsStore.removeStudentsViaEmail(emails.value)
}
