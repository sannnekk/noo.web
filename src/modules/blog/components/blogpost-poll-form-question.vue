<template>
  <div class="blogpost-poll-form-question">
    <div class="blogpost-poll-form-question__title">
      <h4>Вопрос {{ index + 1 }}</h4>
      <span class="blogpost-poll-form-question__title__delete-button">
        <inline-icon
          name="delete"
          @click="$emit('remove')"
        />
    ...
    <div class="blogpost-poll-form-question__form">
      <form-checkbox
        label="Обязательный"
    ...
    <div
      class="blogpost-poll-form-question__type-specific-form"
      v-auto-animate
    >
      <component
